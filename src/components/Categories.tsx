...
const Categories = () => {
  ...
  return (
    <section id="categorias" className="pb-32 pt-28 bg-[#F8FAFC] dark:bg-slate-900 transition-colors duration-500 relative scroll-mt-28">
      <div className="pointer-events-none absolute top-0 left-0 w-full h-24 bg-gradient-to-b from-[#F8FAFC] to-transparent dark:from-slate-900 dark:to-transparent" />
      <FadeIn>
