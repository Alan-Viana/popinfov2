...
const Footer = () => {
  return (
    <footer className="bg-white dark:bg-[#080808] text-slate-600 dark:text-slate-300 pt-8 pb-6 mt-auto border-t border-slate-200 dark:border-[#242424] transition-colors duration-300">
